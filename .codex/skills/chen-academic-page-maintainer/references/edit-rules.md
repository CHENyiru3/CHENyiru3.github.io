...
- Research Radar page and renderer UI wording, as long as the academic-article-only contract is preserved
...
- Research Radar article rankings, summaries, metadata, and recommendation labels generated by the external agent
